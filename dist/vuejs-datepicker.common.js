...
var utils = {
  ...
  getWeek: function getWeek (date) {
    ...
    var week1 = new Date(this.getFullYear(tempDate), 0, 4);
...
(function(){ if(typeof document !== 'undefined'){ var head=document.head||document.getElementsByTagName('head')[0], style=document.createElement('style'), css=""; style.type='text/css'; if (style.styleSheet){ style.styleSheet.cssText = css; } else { style.appendChild(document.createTextNode(css)); } head.appendChild(style); } })();
var PickerDay = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.showDayView),expression:"showDayView"}],class:[_vm.calendarClass, 'vdp-datepicker__calendar', _vm.showWeekNumber ? 'including_week-number': '' ],style:(_vm.calendarStyle),on:{"mousedown":function($event){$event.preventDefault();}}},[_vm._t("beforeCalendarHeader"),_vm._v(" "),_c('header',[_c('span',{staticClass:"prev",class:{'disabled': _vm.isLeftNavDisabled},on:{"click":function($event){_vm.isRtl ? _vm.nextMonth() : _vm.previousMonth();}}},[_vm._v("<")]),_vm._v(" "),_c('span',{staticClass:"day__month_btn",class:_vm.allowedToShowView('month') ? 'up' : '',on:{"click":_vm.showMonthCalendar}},[_vm._v(_vm._s(_vm.isYmd ? _vm.currYearName : _vm.currMonthName)+" "+_vm._s(_vm.isYmd ? _vm.currMonthName : _vm.currYearName))]),_vm._v(" "),_c('span',{staticClass:"next",class:{'disabled': _vm.isRightNavDisabled},on:{"click":function($event){_vm.isRtl ? _vm.previousMonth() : _vm.nextMonth();}}},[_vm._v(">")])]),_vm._v(" "),_c('div',{class:_vm.isRtl ? 'flex-rtl' : ''},[_c('span',{staticClass:"cell day-header week-number"},[_vm._v("KW")]),_vm._l((_vm.daysOfWeek),function(d){return _c('span',{key:d.timestamp,staticClass:"cell day-header"},[_vm._v(_vm._s(d))])}),_vm._v(" "),_vm._l((_vm.weeks),function(week,index){return _c('div',{key:week[0].timestamp,staticClass:"week",class:_vm.weekClasses(week)},[(_vm.showWeekNumber)?_c('span',{staticClass:"cell week-number"},[_vm._v(_vm._s(week[0].weekNumber))]):_vm._e(),(index === 0 && _vm.blankDays > 0)?_vm._l((_vm.blankDays),function(d){return _c('span',{key:d.timestamp,staticClass:"cell day blank"})}):_vm._e(),_vm._l((week),function(day){return _c('span',{key:day.timestamp,staticClass:"cell day",class:_vm.dayClasses(day),domProps:{"innerHTML":_vm._s(_vm.dayCellContent(day))},on:{"click":function($event){_vm.selectDate(day);}}})})],2)})],2)],2)},staticRenderFns: [],
  props: {
    showDayView: Boolean,
  ...
  computed: {
    ...
    days: function days () {
      ...
      for (var i = 0; i < daysInMonth; i++) {
        days.push({
          ...
          isMonday: this$1.utils.getDay(dObj) === 1,
          weekNumber: this$1.utils.getWeek(dObj)
        });
    ...
    weeks: function weeks () {
      ...
      var weeks = this.days.reduce(function (weeks, day, index) {
        var isFirstDayOfWeek = this$1.mondayFirst ? day.isMonday : day.isSunday;
  ...
  methods: {
     ...
     * @return {Boolean}
     */
    isSelectedWeek: function isSelectedWeek (week) {
      return week.some(function (day) { return day.isSelected; })
    },
    /**
    ...
    weekClasses: function weekClasses (week) {
      return {
